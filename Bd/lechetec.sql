...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 22-05-2026 a las 22:56:29
...
INSERT INTO `usuarios` (`id`, `usuario`, `password`, `rol`, `numero_control`, `estado`) VALUES
(1, 'maicol', '$2y$10$2kYPUIbce06OOJAmVXJfD.3KDS/daHmrLSF6Ya/kSHUiVzs2PQCcq', 'admin', '12345', 'activo'),
(2, 'maicol1', '$2y$10$S8qfw5JomlmEVGEDPdEX0.h2H.GbvNGC9cOu3Dx16xv79gSFunpdC', 'usuario', '123456', 'activo'),
(3, 'esteban ', '$2y$10$MPp7rHukzb2He3gQyWm9uO4GWHuRRWyxTMYZvYBhMjA2xwIiXtKH.', 'usuario', '132', 'activo'),
(4, 'fer', '$2y$10$TV/FfGQouWVsxGjvz3g/EuRGmvKNUVXr9bDUW85HuuYqmU0vzTBf6', 'usuario', '11', 'activo'),
(7, 'anibal ', '$2y$10$bG37RXpkoZgxngpGmNRmOez9MCO6pX0FmVJzQoUkIiheb4URvlgQG', 'usuario', '823918', 'activo'),
(8, 'camila', '$2y$10$BI1sXUHb91JE1OY.fBwlx.I1ORw9v7InoR815SVicx22avypFf0/m', 'usuario', '0000', 'activo');
...
--
ALTER TABLE `analisis_fq`
  MODIFY `ID_AFQ` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT de la tabla `analisis_micro`
--
ALTER TABLE `analisis_micro`
  MODIFY `ID_MIC` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT de la tabla `muestra`
--
ALTER TABLE `muestra`
  MODIFY `ID_MUE` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
